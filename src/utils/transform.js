...
(function() {
    ...
    Matrix3D.prototype = {
        ...
        appendTransform: function(
            ...
            this.multiplyMatrices(
                this,
                this._arrayWrap([1, 0, 0, x, 0, cosx, sinx, y, 0, -sinx, cosx, z, 0, 0, 0, 1])
            );

            this.multiplyMatrices(
                this,
                this._arrayWrap([cosy, 0, siny, 0, 0, 1, 0, 0, -siny, 0, cosy, 0, 0, 0, 0, 1])
            );
            ...
            if (skewX || skewY) {
                this.multiplyMatrices(
                    this,
                    this._arrayWrap([
                        this._rounded(Math.cos(skewX * DEG_TO_RAD)),
                        this._rounded(Math.sin(skewX * DEG_TO_RAD)),
                        0,
                        0,
                        -1 * this._rounded(Math.sin(skewY * DEG_TO_RAD)),
                        this._rounded(Math.cos(skewY * DEG_TO_RAD)),
                        0,
                        0,
                        0,
                        0,
    ...
    function Transform(obj, notPerspective) {
        ...
        observe(obj, observeProps, function() {
            ...
            let transform =
                (notPerspective ? '' : 'perspective(' + obj.perspective + 'px) ') +
                'matrix3d(' +
